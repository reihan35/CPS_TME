...
short src_ln1 [] = {
	  0,  33,  35,  36,  39,  42,  42,  43, 
	 43,  43,  41,  45,  45,  46,  47,  48, 
	 49,  50,  38,  52,  52,  52,  34,  55, 
	 34,  55,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "mutex2.pml", 1, 25 },
...
short src_ln0 [] = {
	  0,   8,  10,  11,  14,  17,  17,  18, 
	 18,  18,  16,  20,  20,  21,  22,  23, 
	 24,  25,  13,  27,  27,  27,   9,  29, 
	  9,  29,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "mutex2.pml", 1, 25 },
...
{	int j, h = now._nr_pr;
	...
	case 1:	/* proc2 */
		...
		reached1[1]=1;
		/* params: */
		((P1 *)pptr(h))->repeat = par0;
		/* locals: */
		((P1 *)pptr(h))->count = 0;
#ifdef VAR_RANGES
		logval("proc2:repeat", ((P1 *)pptr(h))->repeat);
		logval("proc2:count", ((P1 *)pptr(h))->count);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* proc1 */
		...
		reached0[1]=1;
		/* params: */
		((P0 *)pptr(h))->repeat = par0;
		/* locals: */
		((P0 *)pptr(h))->count = 0;
#ifdef VAR_RANGES
		logval("proc1:repeat", ((P0 *)pptr(h))->repeat);
		logval("proc1:count", ((P0 *)pptr(h))->count);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	case 2:
		...
		break;
	case 1:
		printf("local vars proc %d (proc2):\n", pid);
	printf("	int    repeat:	%d\n", ((P1 *)pptr(pid))->repeat);
	printf("	int    count:	%d\n", ((P1 *)pptr(pid))->count);
		break;
	case 0:
		printf("local vars proc %d (proc1):\n", pid);
	printf("	int    repeat:	%d\n", ((P0 *)pptr(pid))->repeat);
	printf("	int    count:	%d\n", ((P0 *)pptr(pid))->count);
		break;
	}
